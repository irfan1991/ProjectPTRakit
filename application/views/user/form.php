	...
	<?php echo form_open_multipart('auth/register'); ?>
		<!-- begin form -->
			...
			<div class="col-md-4">	<!-- begin col -->
								...
								<?= form_error('username');?>
								<input class="form-control" type="text" name="username" placeholder="Enter username" data-rule-required="true" value="<?= set_value('username')?>">
								</div>
								<div class="form-group">
								<label>Email</label>
								<?= form_error('email');?>
								<input class="form-control" type="text" name="email" placeholder="Enter email" data-rule-required="true" value="<?= set_value('email')?>">
								</div>
								<div class="form-group">
								...
								<?= form_error('');?>
								<input id="cpassword" class="form-control" type="password" name="confirm" placeholder="Enter password again ">
								</div>
								<div class="form-group">
