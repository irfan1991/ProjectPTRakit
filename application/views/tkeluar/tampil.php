...
foreach($sql as $r): ?>
  ...
  <td><?php echo $r->diagnosa; ?></td>
   <td><?php echo $r->status == 0 ? 'Kecelakaan' : 'Non Kecelakaan' ?></td>
       ...
       <td>
     <a href="<?php echo site_url('transaksiK/ubah/'.$r->id); ?>" class="tip btn btn-sm btn-default"  title="Edit" ><i class="glyphicon glyphicon-edit" ></i></a> 
      
    &nbsp | &nbsp 
   <a href="#" data-url="<?php echo site_url('transaksiK/hapus/'.$r->id); ?>" class="tip btn btn-sm btn-default confirm_delete"  title="Hapus" ><i class="glyphicon glyphicon-trash" ></i></a> 
  &nbsp | &nbsp 
   <a href="<?php echo site_url('transaksiK/kuitansi/'.$r->id); ?>" class="tip btn btn-sm btn-default"  title="Cetak" ><i class="glyphicon glyphicon-print" ></i></a> 
...
?>            
      ...
      <?php
      echo form_open('transaksiK/pdf');
      ?>
      <table class="table table-bordered">
          <tr><td>
          <div class="col-sm-2"">
                      <h5>Cetak Laporan Kunjungan Periode </h5>
                  </div>
                  <div class="col-sm-2"">
	   ...
	   <?php
		echo form_open('transaksiK/rekap');
      ?>
      <table class="table table-bordered">
          <tr><td>
          <div class="col-sm-2"">
                      <h5>Cetak Laporan Rekap Transaksi Periode </h5>
                  </div>
                  <div class="col-sm-2"">
                      <input type="text" name="tanggal3" class="form-control" id="tgl" placeholder="Dari Tanggal">
                  </div>
                  <div class="col-sm-2"">
                      <input type="text" name="tanggal4" class="form-control" id="tgl2" placeholder="Sampai Tanggal">
                  </div>
                  <button class="btn btn-danger btn-dangar" type="submit" name="submit">Cetak</button> 
